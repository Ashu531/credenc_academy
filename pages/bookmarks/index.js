            ...
            <div className='bookmark-content'>
              {
                ...
                style={ window.innerWidth < 500 ? {marginTop: '6rem',gap: 10,padding: '0rem 0rem 8rem 0rem',display:'block'} : courses && courses.length > 0 ? {gap: 10, position: "absolute", top: '14rem', left: '30px', paddingBottom: '6rem'} : {gap: 10}}
                >
                  <List
