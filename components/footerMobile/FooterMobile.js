        ...
        <div className='mobile-footer' style={location.pathname === '/search/' || location.pathname === '/details' || (filterValues.length > 0 && location.pathname !== '/bookmarks' && location.pathname !== '/') ? { opacity: 0 } : props?.filterModalVisible ? { zIndex: 0 } : null}>
            <div className='mobile-footer-container'>
                ...
                <div className='mobile-footer-element'>
                    <div className='imageContainer'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" style={location.pathname === '/search' && !props?.loginModal ? {color:'#8F14CC'} : null}><rect width="24px" height="24px" fill="none" /><circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" strokeWidth="16" /></svg>
                    </div>
